...
class KalmanFilter:
    ...
    def initiate(self, measurement: np.ndarray) -> Tuple[np.ndarray, np.ndarray]:
        ...
        Args:
            measurement (np.ndarray): Bounding box coordinates (x, y, a, h) with
                center position (x, y), aspect ratio a, and height h.

        Returns:
            Tuple[np.ndarray, np.ndarray]: Returns the mean vector (8 dimensional) and
    ...
    def predict(self, mean: np.ndarray, covariance: np.ndarray) -> Tuple[np.ndarray, np.ndarray]:
        ...
        Args: mean (np.ndarray): The 8 dimensional mean vector of the object state at the previous time step.
        covariance (np.ndarray): The 8x8 dimensional covariance matrix of the object state at the previous time step.

        Returns:
            Tuple[np.ndarray, np.ndarray]: Returns the mean vector and covariance matrix of the predicted state.
                Unobserved velocities are initialized to 0 mean.
        """
        std_pos = [
    ...
    def project(self, mean: np.ndarray, covariance: np.ndarray) -> Tuple[np.ndarray, np.ndarray]:
        ...
        Returns:
            Tuple[np.ndarray, np.ndarray]: Returns the projected mean and covariance matrix of the given state estimate.
        """
        std = [
            self._std_weight_position * mean[3],
            self._std_weight_position * mean[3],
    ...
    def multi_predict(self, mean: np.ndarray, covariance: np.ndarray) -> Tuple[np.ndarray, np.ndarray]:
        ...
        Args: mean (np.ndarray): The Nx8 dimensional mean matrix of the object states at the previous time step.
        covariance (np.ndarray): The Nx8x8 dimensional covariance matrices of the object states at the previous time
        step.
